...
public class MIClicked : MonoBehaviour
{
    //initialize variables
    public int coins;
    public string MIOwned;
    ...
    {
        coins = GetInt("Cash");
        MIOwned = GetString("MIOwned");

        if (MIOwned == "True")
        {
            SetString("SelectedTeam", "MI");
        }
        ...
        else
        {
            if (MIOwned == "False")
            {
                SetString("NotEnoughCoinsForMI", "True");
            }
        }
    }
