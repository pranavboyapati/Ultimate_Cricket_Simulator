...
public class GTClicked : MonoBehaviour
{
    //initialize variables
    public int coins;
    public string GTOwned;
    ...
    {
        coins = GetInt("Cash");
        GTOwned = GetString("GTOwned");

        if (GTOwned == "True")
        {
            SetString("SelectedTeam", "GT");
        }
        ...
        else
        {
            if (GTOwned == "False")
            {
                SetString("NotEnoughCoinsForGT", "True");
            }
        }
    }
