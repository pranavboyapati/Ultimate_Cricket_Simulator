...
public class PKTextUpdate : MonoBehaviour
{           
    ...
    //this function tells the user the status of the team, whether it is owned, selected, or unable to be purchase    
    public void Update()
    {
        ...
        insufficientCoins = GetString("NotEnoughCoinsForPK");
