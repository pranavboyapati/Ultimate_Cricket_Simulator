...
public class ManageTeamsButton : MonoBehaviour
{
    //this function ensures all values are initialized in the playerprefs dictionary and loads the manage teams pages
    public void main()
    {
